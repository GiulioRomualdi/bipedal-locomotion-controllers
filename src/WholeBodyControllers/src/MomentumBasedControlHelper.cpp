...
// BipedalLocomotion library
#include <BipedalLocomotion/OptimalControlUtilities/CartesianElements.h>
#include <BipedalLocomotion/OptimalControlUtilities/CentroidalMomentumElementsWithCompliantContacts.h>
...
#include <BipedalLocomotion/WholeBodyControllers/MomentumBasedControlHelper.h>

using namespace BipedalLocomotion::WholeBodyControllers;
using namespace BipedalLocomotion::OptimalControlUtilities;
                                            ...
                                            const iDynTree::VectorDynSize& minJointsPosition)
{
    ...
    auto rootOptions = handler->getGroup("ROOT");
    if (auto ptr = rootOptions.lock())
    {
        OptimalControlUtilities::Frame<std::string, std::string> torsoIdentifiers;
        torsoIdentifiers.identifierInVariableHandler() = "root";
        if(!ptr->getParameter("frame_name", torsoIdentifiers.identifierInModel()))
        {
            std::cerr << "[MomentumBasedControlHelper::initialize] Unable to add the find the torso frame name"
                      << std::endl;
