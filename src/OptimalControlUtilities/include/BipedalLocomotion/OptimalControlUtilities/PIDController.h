...
#ifndef BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_PID_CONTROLLER_H
#define BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_PID_CONTROLLER_H
...
#endif // BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_PD_CONTROLLER_H
