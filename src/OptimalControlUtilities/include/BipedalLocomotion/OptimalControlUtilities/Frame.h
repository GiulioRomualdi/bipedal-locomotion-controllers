...
#ifndef BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_FRAME_H
#define BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_FRAME_H
...
#endif // BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_FRAME_H
