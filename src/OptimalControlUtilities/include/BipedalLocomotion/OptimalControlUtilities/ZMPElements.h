...
#ifndef BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_ZMP_ELEMENT_H
#define BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_ZMP_ELEMENT_H
...
#endif // BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_ZMP_ELEMENT_H
