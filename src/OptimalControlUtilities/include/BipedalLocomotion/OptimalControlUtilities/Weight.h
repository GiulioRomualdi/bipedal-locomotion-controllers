...
#ifndef BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_WEIGHT_H
#define BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_WEIGHT_H
...
#endif // BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_WEIGHT_H
