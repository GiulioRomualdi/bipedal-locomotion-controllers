...
#ifndef BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_CONTROL_PROBLEM_ELEMENTS_H
#define BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_CONTROL_PROBLEM_ELEMENTS_H
...
#endif // BIPEDAL_LOCOMOTION_OPTIMAL_CONTROL_UTILITIES_CONTROL_PROBLEM_ELEMENTS_H
